      ...
      <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-md flex-col px-5 pt-6 pb-8">
        <header className="flex items-center justify-between">
          ...
          <img
            ...
            height={1024}
            className="h-20 w-20"
            style={{ filter: "drop-shadow(0 10px 18px oklch(0 0 0 / 78%)) drop-shadow(0 0 22px oklch(0.9 0.16 82 / 70%)) drop-shadow(0 0 10px oklch(0.95 0.14 85 / 55%)) contrast(1.22) saturate(1.22) brightness(1.18)" }}
          />
